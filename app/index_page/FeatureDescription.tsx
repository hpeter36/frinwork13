  ...
  return (
    <div className="container my-24 mx-auto md:px-6" id="section-feat-desc">
      <section className="mb-32">
        <h2 className="mb-16 text-center text-2xl font-bold text-secondary_c-900 dark:text-secondary_c-100">
          Latest articles
        </h2>
        ...
        {featDescData.map((d) => (
          ...
          >
            ...
            <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
              <h3 className="mb-4 text-2xl font-bold text-secondary_c-900 dark:text-secondary_c-100">{d.title}</h3>
              <p className="text-secondary_c-700 dark:text-secondary_c-300">{d.text}</p>
            </div>
          </div>
        ))}
      </section>
