...
export type LegendDataElement = {
  ...
  export type BubbleChartInputProps = {
	inputs: BubbleChartInput;
  };
  ...
  export type NormalizedType = {
	[key: string]: NormalizedType | number[];
  };
...
export type BubbleChartToolTipData = {
  ...
  export type BubbleChartToolTipInputProps = { inputs: BubbleChartToolTipData | null };
