...
const BubbleChart: React.FC<BubbleChartInputProps> = (inputs) => {
  ...
  function getSelectedSplitRbtnValueFromEnum(
  ...
  useEffect(() => {
    ...
    const handleUseEffect = async () => {
      ...
      setLegendData(getLegendData(selectedSplit));
      ...
      switch (event.target.value) {
        case "cbx_free":
          if (selected_plan.current != EnumSubscription.FREE) {
            ...
            setLegendData(getLegendData(EnumSelectedSplit.COLLAPSED));
            //setTest("Thrid");
      ...
      switch (event.target.value) {
        ...
        case "cbx_spl_exch":
          if (selectedSplit != EnumSelectedSplit.SPLITTED_EXCH) {
            ...
            setLegendData(getLegendData(EnumSelectedSplit.SPLITTED_EXCH));
        ...
        case "cbx_spl_sector":
          if (selectedSplit != EnumSelectedSplit.SPLITTED_SECTOR) {
            ...
            setLegendData(getLegendData(EnumSelectedSplit.SPLITTED_SECTOR));
